      ...
      <div className="container">
        <div className="row shadow">
          <div className="col-12">
            <h2>Equivalent Air Depth (EAD)</h2>
            <p>
              <i>
                The equivalent air depth for a given Nitrox mix and depth is the
                depth of a dive when breathing air that would have the same
          ...
          <div className="col-12">
            ...
            />{" "}
            - your <b>Fraction of Nitrogen</b> (FN<sub>2</sub>) is{" "}
            ...
            <p>
              Then your Equivalent Air Depth (EAD) (rounding deeper) is
              <span className="result">{this.state.Ead} m</span>
            </p>
          </div>
        </div>
      </div>
