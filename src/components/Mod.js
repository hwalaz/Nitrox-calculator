      ...
      <div className="container">
        <div className="row shadow">
          <div className="col-12">
            ...
            <p>
            <i>Maximum Operating Depth (MOD) is the maximum safe depth at which a given nitrox mixture can be used.
            MOD depends on the allowed partial pressure of oxygen (ppO<sub>2</sub>), which is related to exposure time and the acceptable risk assumed for central nervous system oxygen toxicity.</i>
            </p>
          </div>
          <div className="col-12">
          If you use EAN
          <select value={this.state.Ean} onChange={this.change}>
           ...
           your <b>Fraction of Oxygen</b> (FO<sub>2</sub>) is
            ...
            <p>The <b>Maximum Operating Depth (MOD)</b> is
            <span className="result">{this.state.Mod} m</span> equal to <span className="relevant">{this.state.Ata} ATA</span></p>
          </div>
        </div>
      </div>
    );
