      ...
      <div className="container">
        <div className="row shadow">
          <div className="col-12">
            ...
            <p>
            <i>This utility allows the safe planning a single Enriched Air Nitrox Diving. </i>
            </p>
          </div>
          <div className="col-12">
          ...
          <select value={this.state.Ean} onChange={this.changeEan}>
           ...
           your <b>Fraction of Oxygen</b> (FO<sub>2</sub>) will be
            ...
            /> and your <b>Fraction of Nitrogen</b> (FN<sub>2</sub>) will <span className="relevant">{this.state.FN2}</span>
            ...
            <select value={this.state.ppO2} onChange={this.changePPO2}>
              ...
              <option key="1.4" value="1.4">1.4</option>
              <option key="1.5" value="1.5">1.5</option>
              <option key="1.6" value="1.6">1.6</option>
            </select> bar

          and <b>Maximum Depth</b> of
           ...
           <input
            ...
            <p><span className={this.state.Mod >= this.state.Maxdepth ? 'relevant' : 'error'}>{this.state.Mod >= this.state.Maxdepth ? 'Profile correct' : 'Caution your profile is dangerous'}</span></p>

            <p>
              You want to dive <span className="relevant">{this.state.Maxdepth} m</span> and your MOD is <span className="relevant">{this.state.Mod} m</span>, your
              Equivalent Air Depth (EAD) (rounding deeper) is <span className="relevant">{this.state.Ead} m</span>
              with actual <b>Partial Pressure Oxygen</b> is <span className="relevant">{this.state.appO2}</span>.</p><p>
              Your Best Mix for this dive is <span className="relevant">EAN {this.state.BestMix} %
              </span>
              </p>
          </div>
        </div>
