      ...
      <div className="container">
        <div className="row shadow">
          <div className="col-12">
            ...
            <p>
            <i>The composition of a nitrox mix can be optimized for a given planned dive profile. This is termed "Best mix", for the dive, and provides the maximum no-decompression time compatible with acceptable oxygen exposure.</i>
            </p>
          </div>
          <div className="col-12">
          ...
          <select value={this.state.ppO2} onChange={this.update}>
          ...
          </select> bar and your planned <b>Maximum Depth</b> is
            ...
            <p>Then your Nitrox <b>Best Mix</b> (rounding down) is EAN
            <span className="result">{this.state.Ean}%</span> equal to <span className="relevant">{this.state.FO2} FO<sub>2</sub></span></p>
          </div>
        </div>
      </div>
    );
